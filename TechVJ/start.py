    ...
    for i in range(len(ids)):
        ...
        try:
            ...
            await countdown.edit(count_down, 
                                 buttons=[[Button.url("Join Channel", url="https://t.me/LegendBotzs")]])
            ...
            if int(fw.seconds) > 300:
                await client.send_message(sender, f'You have floodwaits of {fw.seconds} seconds, cancelling batch')
                ids.clear()
                break
            else:
                fw_alert = await client.send_message(sender, f'Sleeping for {fw.seconds + 5} second(s) due to telegram flooodwait.')
                ...
                try:
                    ...
                    if countdown.text != count_down:
                        await countdown.edit(count_down, buttons=[[Button.url("Join Channel", url="http://t.me/LegendBotzs")]])
        except Exception as e:
            logger.info(e)
